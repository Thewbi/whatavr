...
use std::any::{Any,TypeId};
	...
	pub const RULE_numeric:usize = 8; 
	pub const RULE_asm_instrinsic_instruction:usize = 9; 
	pub const RULE_byte_csv:usize = 10; 
	pub const RULE_asm_intrinsic_usage:usize = 11; 
	pub const RULE_preprocessor_directive:usize = 12; 
	pub const RULE_mnemonic:usize = 13; 
	pub const RULE_mnemonic_a:usize = 14; 
	pub const RULE_mnemonic_b:usize = 15; 
	pub const RULE_mnemonic_c:usize = 16; 
	pub const RULE_mnemonic_d:usize = 17; 
	pub const RULE_mnemonic_e:usize = 18; 
	pub const RULE_mnemonic_f:usize = 19; 
	pub const RULE_mnemonic_i:usize = 20; 
	pub const RULE_mnemonic_j:usize = 21; 
	pub const RULE_mnemonic_l:usize = 22; 
	pub const RULE_mnemonic_m:usize = 23; 
	pub const RULE_mnemonic_n:usize = 24; 
	pub const RULE_mnemonic_o:usize = 25; 
	pub const RULE_mnemonic_p:usize = 26; 
	pub const RULE_mnemonic_r:usize = 27; 
	pub const RULE_mnemonic_s:usize = 28; 
	pub const RULE_mnemonic_t:usize = 29; 
	pub const RULE_mnemonic_w:usize = 30; 
	pub const RULE_mnemonic_x:usize = 31;
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for assemblerParserExt<'input>{
	...
	fn sempred(_localctx: Option<&(dyn assemblerParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
		...
		match rule_index {
					...
					10 => assemblerParser::<'input,I,_>::byte_csv_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
fn BINARY_NUMBER(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
...
fn CHAR(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
...
fn ESCAPED_CHAR(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
...
impl<'input> assemblerParserContext<'input> for NumericContext<'input>{}

impl<'input,'a> Listenable<dyn assemblerListener<'input> + 'a> for NumericContext<'input>{
		fn enter(&self,listener: &mut (dyn assemblerListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn assemblerVisitor<'input> + 'a> for NumericContext<'input>{
	fn accept(&self,visitor: &mut (dyn assemblerVisitor<'input> + 'a)) {
...
impl<'input> NumericContextExt<'input>{
	fn new(parent: Option<Rc<dyn assemblerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NumericContextAll<'input>> {
		Rc::new(
...
pub trait NumericContextAttrs<'input>: assemblerParserContext<'input> + BorrowMut<NumericContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<NumericContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 16, RULE_numeric);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 159)) & !0x3f) == 0 && ((1usize << (_la - 159)) & ((1usize << (NUMBER - 159)) | (1usize << (HEX_NUMBER - 159)) | (1usize << (BINARY_NUMBER - 159)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
fn DSEG(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
...
fn DB(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
	self.get_token(DB, 0)
}
...
fn BYTE(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
...
impl<'input> assemblerParserContext<'input> for Byte_csvContext<'input>{}

impl<'input,'a> Listenable<dyn assemblerListener<'input> + 'a> for Byte_csvContext<'input>{
		fn enter(&self,listener: &mut (dyn assemblerListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn assemblerVisitor<'input> + 'a> for Byte_csvContext<'input>{
	fn accept(&self,visitor: &mut (dyn assemblerVisitor<'input> + 'a)) {
...
impl<'input> Byte_csvContextExt<'input>{
	fn new(parent: Option<Rc<dyn assemblerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Byte_csvContextAll<'input>> {
		Rc::new(
...
pub trait Byte_csvContextAttrs<'input>: assemblerParserContext<'input> + BorrowMut<Byte_csvContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Byte_csvContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 20, RULE_byte_csv, _p);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Asm_intrinsic_usageContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 22, RULE_asm_intrinsic_usage);
...
fn BINARY_NUMBER_all(&self) -> Vec<Rc<TerminalNode<'input,assemblerParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn BINARY_NUMBER(&self, i: usize) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Preprocessor_directiveContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 24, RULE_preprocessor_directive);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				match _alt {
					...
					_la = recog.base.input.la(1);
					if { !(((((_la - 134)) & !0x3f) == 0 && ((1usize << (_la - 134)) & ((1usize << (ENDIF - 134)) | (1usize << (IF - 134)) | (1usize << (NUMBER - 134)) | (1usize << (HEX_NUMBER - 134)) | (1usize << (BINARY_NUMBER - 134)) | (1usize << (IDENTIFIER - 134)))) != 0)) } {
						recog.err_handler.recover_inline(&mut recog.base)?;
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<MnemonicContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 26, RULE_mnemonic);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_aContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 28, RULE_mnemonic_a);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_bContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 30, RULE_mnemonic_b);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_cContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 32, RULE_mnemonic_c);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_dContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 34, RULE_mnemonic_d);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_eContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 36, RULE_mnemonic_e);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_fContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 38, RULE_mnemonic_f);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_iContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 40, RULE_mnemonic_i);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_jContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 42, RULE_mnemonic_j);
...
fn LDD(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_lContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 44, RULE_mnemonic_l);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_mContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 46, RULE_mnemonic_m);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_nContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 48, RULE_mnemonic_n);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_oContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 50, RULE_mnemonic_o);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_pContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 52, RULE_mnemonic_p);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_rContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 54, RULE_mnemonic_r);
...
fn STD(&self) -> Option<Rc<TerminalNode<'input,assemblerParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_sContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 56, RULE_mnemonic_s);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_tContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 58, RULE_mnemonic_t);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_wContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 60, RULE_mnemonic_w);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_xContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 62, RULE_mnemonic_x);
...
const _serializedATN:&'static str =
	...
	\u{a4}\u{124}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\
	...
	\x02\x03\x02\x03\x02\x07\x02\x4b\x0a\x02\x0c\x02\x0e\x02\x4e\x0b\x02\x03\
	\x02\x07\x02\x51\x0a\x02\x0c\x02\x0e\x02\x54\x0b\x02\x03\x02\x07\x02\x57\
	\x0a\x02\x0c\x02\x0e\x02\x5a\x0b\x02\x03\x02\x03\x02\x03\x03\x03\x03\x03\
	\x03\x03\x03\x03\x03\x05\x03\x63\x0a\x03\x03\x04\x03\x04\x03\x04\x03\x04\
	\x05\x04\x69\x0a\x04\x05\x04\x6b\x0a\x04\x03\x05\x05\x05\x6e\x0a\x05\x03\
	\x05\x03\x05\x05\x05\x72\x0a\x05\x03\x05\x03\x05\x03\x05\x05\x05\x77\x0a\
	\x05\x03\x06\x03\x06\x07\x06\x7b\x0a\x06\x0c\x06\x0e\x06\x7e\x0b\x06\x03\
	...
	\x09\x03\x09\x03\x09\x03\x09\x05\x09\u{96}\x0a\x09\x03\x09\x03\x09\x03\x09\
	\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\
	\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\
	\x03\x09\x03\x09\x03\x09\x07\x09\u{b0}\x0a\x09\x0c\x09\x0e\x09\u{b3}\x0b\
	...
	\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\
	\x0b\x03\x0b\x05\x0b\u{d1}\x0a\x0b\x03\x0c\x03\x0c\x03\x0c\x03\x0c\x03\x0c\
	\x03\x0c\x07\x0c\u{d9}\x0a\x0c\x0c\x0c\x0e\x0c\u{dc}\x0b\x0c\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x05\x0d\u{e2}\x0a\x0d\x03\x0d\x03\x0d\x03\x0e\x03\x0e\
	\x06\x0e\u{e8}\x0a\x0e\x0d\x0e\x0e\x0e\u{e9}\x03\x0f\x03\x0f\x03\x0f\x03\
	\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\
	\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x05\x0f\u{fe}\x0a\x0f\x03\x10\
	...
	\x03\x1e\x03\x1e\x03\x1f\x03\x1f\x03\x20\x03\x20\x03\x21\x03\x21\x03\x21\
	\x02\x04\x10\x16\x22\x02\x04\x06\x08\x0a\x0c\x0e\x10\x12\x14\x16\x18\x1a\
	\x1c\x1e\x20\x22\x24\x26\x28\x2a\x2c\x2e\x30\x32\x34\x36\x38\x3a\x3c\x3e\
	\x40\x02\x15\x04\x02\u{93}\u{93}\u{96}\u{96}\x03\x02\u{a1}\u{a3}\x04\x02\
	\u{a2}\u{a2}\u{a4}\u{a4}\x03\x02\u{a1}\u{a2}\x05\x02\u{88}\u{88}\u{8e}\u{8e}\
	\u{a1}\u{a4}\x03\x02\x03\x08\x03\x02\x09\x21\x03\x02\x22\x32\x03\x02\x33\
	\x34\x03\x02\x35\x38\x03\x02\x39\x3b\x03\x02\x3c\x3f\x03\x02\x41\x4a\x03\
	\x02\x4b\x4f\x03\x02\x50\x51\x03\x02\x52\x54\x03\x02\x55\x56\x03\x02\x57\
	\x5c\x03\x02\x5d\x76\x02\u{146}\x02\x45\x03\x02\x02\x02\x04\x62\x03\x02\
	\x02\x02\x06\x64\x03\x02\x02\x02\x08\x76\x03\x02\x02\x02\x0a\x78\x03\x02\
	\x02\x02\x0c\x7f\x03\x02\x02\x02\x0e\u{82}\x03\x02\x02\x02\x10\u{95}\x03\
	\x02\x02\x02\x12\u{b4}\x03\x02\x02\x02\x14\u{b6}\x03\x02\x02\x02\x16\u{d2}\
	\x03\x02\x02\x02\x18\u{dd}\x03\x02\x02\x02\x1a\u{e5}\x03\x02\x02\x02\x1c\
	\x02\u{d0}\u{b9}\x03\x02\x02\x02\u{d0}\u{bb}\x03\x02\x02\x02\u{d0}\u{bd}\
	\x03\x02\x02\x02\u{d0}\u{bf}\x03\x02\x02\x02\u{d0}\u{c0}\x03\x02\x02\x02\
	\u{d0}\u{c1}\x03\x02\x02\x02\u{d0}\u{c3}\x03\x02\x02\x02\u{d0}\u{c5}\x03\
	\x02\x02\x02\u{d0}\u{c7}\x03\x02\x02\x02\u{d0}\u{c9}\x03\x02\x02\x02\u{d0}\
	\u{ca}\x03\x02\x02\x02\u{d0}\u{cc}\x03\x02\x02\x02\u{d0}\u{cd}\x03\x02\x02\
	\x02\u{d0}\u{ce}\x03\x02\x02\x02\u{d1}\x15\x03\x02\x02\x02\u{d2}\u{d3}\x08\
	\x0c\x01\x02\u{d3}\u{d4}\x09\x05\x02\x02\u{d4}\u{da}\x03\x02\x02\x02\u{d5}\
	\u{d6}\x0c\x04\x02\x02\u{d6}\u{d7}\x07\x7f\x02\x02\u{d7}\u{d9}\x09\x05\x02\
	\x02\u{d8}\u{d5}\x03\x02\x02\x02\u{d9}\u{dc}\x03\x02\x02\x02\u{da}\u{d8}\
	\x03\x02\x02\x02\u{da}\u{db}\x03\x02\x02\x02\u{db}\x17\x03\x02\x02\x02\u{dc}\
	\u{da}\x03\x02\x02\x02\u{dd}\u{de}\x07\u{a4}\x02\x02\u{de}\u{e1}\x07\u{94}\
	\x02\x02\u{df}\u{e2}\x07\u{a4}\x02\x02\u{e0}\u{e2}\x05\x0e\x08\x02\u{e1}\
	\u{df}\x03\x02\x02\x02\u{e1}\u{e0}\x03\x02\x02\x02\u{e2}\u{e3}\x03\x02\x02\
	\x02\u{e3}\u{e4}\x07\x7d\x02\x02\u{e4}\x19\x03\x02\x02\x02\u{e5}\u{e7}\x07\
	\u{8d}\x02\x02\u{e6}\u{e8}\x09\x06\x02\x02\u{e7}\u{e6}\x03\x02\x02\x02\u{e8}\
	\u{e9}\x03\x02\x02\x02\u{e9}\u{e7}\x03\x02\x02\x02\u{e9}\u{ea}\x03\x02\x02\
	\x02\u{ea}\x1b\x03\x02\x02\x02\u{eb}\u{fe}\x05\x1e\x10\x02\u{ec}\u{fe}\x05\
	\x20\x11\x02\u{ed}\u{fe}\x05\x22\x12\x02\u{ee}\u{fe}\x05\x24\x13\x02\u{ef}\
	\u{fe}\x05\x26\x14\x02\u{f0}\u{fe}\x05\x28\x15\x02\u{f1}\u{fe}\x05\x2a\x16\
	\x02\u{f2}\u{fe}\x05\x2c\x17\x02\u{f3}\u{fe}\x05\x2e\x18\x02\u{f4}\u{fe}\
	\x05\x30\x19\x02\u{f5}\u{fe}\x05\x32\x1a\x02\u{f6}\u{fe}\x05\x34\x1b\x02\
	\u{f7}\u{fe}\x05\x36\x1c\x02\u{f8}\u{fe}\x05\x38\x1d\x02\u{f9}\u{fe}\x05\
