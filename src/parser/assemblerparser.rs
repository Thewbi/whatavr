...
use std::any::{Any,TypeId};
		...
		pub const DEF:isize=126; 
		pub const DEVICE:isize=127; 
		...
		pub const HASH_TAG:isize=136; 
		pub const IF:isize=137; 
		pub const INCLUDE:isize=138; 
		pub const LEFT_SHIFT:isize=139; 
		pub const LT:isize=140; 
		pub const MACRO:isize=141; 
		pub const MINUS:isize=142; 
		pub const OPENING_BRACKET:isize=143; 
		pub const ORG:isize=144; 
		pub const PLUS:isize=145; 
		pub const RIGHT_SHIFT:isize=146; 
		pub const SLASH:isize=147; 
		pub const NEWLINE:isize=148; 
		pub const WS:isize=149; 
		pub const LINE_COMMENT:isize=150; 
		pub const BLOCK_COMMENT:isize=151; 
		pub const DOUBLE_SLASH_LINE_COMMENT:isize=152; 
		pub const STRING:isize=153; 
		pub const NUMBER:isize=154; 
		pub const HEX_NUMBER:isize=155; 
		pub const BINARY_NUMBER:isize=156; 
		pub const IDENTIFIER:isize=157;
	...
	pub const RULE_preprocessor_directive:usize = 11; 
	pub const RULE_mnemonic:usize = 12; 
	pub const RULE_mnemonic_a:usize = 13; 
	pub const RULE_mnemonic_b:usize = 14; 
	pub const RULE_mnemonic_c:usize = 15; 
	pub const RULE_mnemonic_d:usize = 16; 
	pub const RULE_mnemonic_e:usize = 17; 
	pub const RULE_mnemonic_f:usize = 18; 
	pub const RULE_mnemonic_i:usize = 19; 
	pub const RULE_mnemonic_j:usize = 20; 
	pub const RULE_mnemonic_l:usize = 21; 
	pub const RULE_mnemonic_m:usize = 22; 
	pub const RULE_mnemonic_n:usize = 23; 
	pub const RULE_mnemonic_o:usize = 24; 
	pub const RULE_mnemonic_p:usize = 25; 
	pub const RULE_mnemonic_r:usize = 26; 
	pub const RULE_mnemonic_s:usize = 27; 
	pub const RULE_mnemonic_t:usize = 28; 
	pub const RULE_mnemonic_w:usize = 29; 
	pub const RULE_mnemonic_x:usize = 30;
	pub const ruleNames: [&'static str; 31] =  [
		...
		"mnemonic_i", "mnemonic_j", "mnemonic_l", "mnemonic_m", "mnemonic_n", 
		"mnemonic_o", "mnemonic_p", "mnemonic_r", "mnemonic_s", "mnemonic_t", 
		"mnemonic_w", "mnemonic_x"
	];


	pub const _LITERAL_NAMES: [Option<&'static str>;148] = [
		...
		Some("'def'"), Some("'device'"), Some("'.'"), Some("'else'"), Some("'endmacro'"), 
		Some("'endif'"), Some("'='"), None, Some("'error'"), Some("'>'"), Some("'#'"), 
	...
	pub const _SYMBOLIC_NAMES: [Option<&'static str>;158]  = [
		...
		Some("DEF"), Some("DEVICE"), Some("DOT"), Some("ELSE"), Some("END_MACRO"), 
		Some("ENDIF"), Some("EQUALS"), Some("EQU"), Some("ERROR"), Some("GT"), 
		Some("HASH_TAG"), Some("IF"), Some("INCLUDE"), Some("LEFT_SHIFT"), Some("LT"), 
		Some("MACRO"), Some("MINUS"), Some("OPENING_BRACKET"), Some("ORG"), Some("PLUS"), 
		Some("RIGHT_SHIFT"), Some("SLASH"), Some("NEWLINE"), Some("WS"), Some("LINE_COMMENT"), 
		Some("BLOCK_COMMENT"), Some("DOUBLE_SLASH_LINE_COMMENT"), Some("STRING"), 
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<NumericContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 154)) & !0x3f) == 0 && ((1usize << (_la - 154)) & ((1usize << (NUMBER - 154)) | (1usize << (HEX_NUMBER - 154)) | (1usize << (BINARY_NUMBER - 154)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Preprocessor_directiveContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 22, RULE_preprocessor_directive);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				match _alt {
					...
					_la = recog.base.input.la(1);
					if { !(((((_la - 131)) & !0x3f) == 0 && ((1usize << (_la - 131)) & ((1usize << (ENDIF - 131)) | (1usize << (IF - 131)) | (1usize << (NUMBER - 131)) | (1usize << (HEX_NUMBER - 131)) | (1usize << (BINARY_NUMBER - 131)) | (1usize << (IDENTIFIER - 131)))) != 0)) } {
						recog.err_handler.recover_inline(&mut recog.base)?;
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<MnemonicContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 24, RULE_mnemonic);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_aContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 26, RULE_mnemonic_a);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_bContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 28, RULE_mnemonic_b);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_cContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 30, RULE_mnemonic_c);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_dContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 32, RULE_mnemonic_d);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_eContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 34, RULE_mnemonic_e);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_fContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 36, RULE_mnemonic_f);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_iContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 38, RULE_mnemonic_i);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_jContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 40, RULE_mnemonic_j);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_lContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 42, RULE_mnemonic_l);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_mContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 44, RULE_mnemonic_m);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_nContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 46, RULE_mnemonic_n);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_oContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 48, RULE_mnemonic_o);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_pContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 50, RULE_mnemonic_p);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_rContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 52, RULE_mnemonic_r);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_sContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 54, RULE_mnemonic_s);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_tContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 56, RULE_mnemonic_t);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_wContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 58, RULE_mnemonic_w);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Mnemonic_xContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 60, RULE_mnemonic_x);
...
const _serializedATN:&'static str =
	...
	\u{9f}\u{110}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\
	...
	\x20\x03\x02\x07\x02\x42\x0a\x02\x0c\x02\x0e\x02\x45\x0b\x02\x03\x02\x03\
	\x02\x07\x02\x49\x0a\x02\x0c\x02\x0e\x02\x4c\x0b\x02\x03\x02\x07\x02\x4f\
	\x0a\x02\x0c\x02\x0e\x02\x52\x0b\x02\x03\x02\x07\x02\x55\x0a\x02\x0c\x02\
	\x0e\x02\x58\x0b\x02\x03\x02\x03\x02\x03\x03\x03\x03\x03\x03\x03\x03\x03\
	\x03\x05\x03\x61\x0a\x03\x03\x04\x03\x04\x03\x04\x03\x04\x05\x04\x67\x0a\
	\x04\x05\x04\x69\x0a\x04\x03\x05\x05\x05\x6c\x0a\x05\x03\x05\x03\x05\x05\
	\x05\x70\x0a\x05\x03\x05\x03\x05\x03\x05\x05\x05\x75\x0a\x05\x03\x06\x03\
	\x06\x07\x06\x79\x0a\x06\x0c\x06\x0e\x06\x7c\x0b\x06\x03\x07\x03\x07\x03\
	\x07\x03\x08\x03\x08\x03\x08\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\
	\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x05\
	\x09\u{92}\x0a\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\x03\x09\
	...
	\u{ac}\x0a\x09\x0c\x09\x0e\x09\u{af}\x0b\x09\x03\x0a\x03\x0a\x03\x0b\x03\
	\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\
	\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\x0b\x03\
	\x0b\x03\x0b\x05\x0b\u{c8}\x0a\x0b\x03\x0c\x03\x0c\x03\x0c\x03\x0c\
	\x02\u{b6}\u{c8}\x07\u{9f}\x02\x02\u{b7}\u{b8}\x07\u{80}\x02\x02\u{b8}\u{c8}\
	\x05\x10\x09\x02\u{b9}\u{ba}\x07\u{87}\x02\x02\u{ba}\u{c8}\x05\x10\x09\x02\
	\u{bb}\u{c8}\x07\x7f\x02\x02\u{bc}\u{bd}\x07\u{92}\x02\x02\u{bd}\u{c8}\x09\
	\x04\x02\x02\u{be}\u{bf}\x07\u{8f}\x02\x02\u{bf}\u{c8}\x07\u{9f}\x02\x02\
	\u{c0}\u{c8}\x07\u{84}\x02\x02\u{c1}\u{c2}\x07\u{8b}\x02\x02\u{c2}\u{c8}\
	\x05\x10\x09\x02\u{c3}\u{c8}\x07\u{83}\x02\x02\u{c4}\u{c8}\x07\u{85}\x02\
	\x02\u{c5}\u{c6}\x07\u{88}\x02\x02\u{c6}\u{c8}\x07\u{9b}\x02\x02\u{c7}\u{b3}\
	\x03\x02\x02\x02\u{c7}\u{b5}\x03\x02\x02\x02\u{c7}\u{b7}\x03\x02\x02\x02\
	\u{c7}\u{b9}\x03\x02\x02\x02\u{c7}\u{bb}\x03\x02\x02\x02\u{c7}\u{bc}\x03\
	\x02\x02\x02\u{c7}\u{be}\x03\x02\x02\x02\u{c7}\u{c0}\x03\x02\x02\x02\u{c7}\
	\u{c1}\x03\x02\x02\x02\u{c7}\u{c3}\x03\x02\x02\x02\u{c7}\u{c4}\x03\x02\x02\
	\x02\u{c7}\u{c5}\x03\x02\x02\x02\u{c8}\x15\x03\x02\x02\x02\u{c9}\u{ca}\x07\
	\u{9f}\x02\x02\u{ca}\u{cd}\x07\u{91}\x02\x02\u{cb}\u{ce}\x07\u{9f}\x02\x02\
	\u{cc}\u{ce}\x05\x0e\x08\x02\u{cd}\u{cb}\x03\x02\x02\x02\u{cd}\u{cc}\x03\
	\x02\x02\x02\u{ce}\u{cf}\x03\x02\x02\x02\u{cf}\u{d0}\x07\x7c\x02\x02\u{d0}\
	\x17\x03\x02\x02\x02\u{d1}\u{d3}\x07\u{8a}\x02\x02\u{d2}\u{d4}\x09\x05\x02\
	\x02\u{d3}\u{d2}\x03\x02\x02\x02\u{d4}\u{d5}\x03\x02\x02\x02\u{d5}\u{d3}\
	\x03\x02\x02\x02\u{d5}\u{d6}\x03\x02\x02\x02\u{d6}\x19\x03\x02\x02\x02\u{d7}\
	\u{ea}\x05\x1c\x0f\x02\u{d8}\u{ea}\x05\x1e\x10\x02\u{d9}\u{ea}\x05\x20\x11\
	\x02\u{da}\u{ea}\x05\x22\x12\x02\u{db}\u{ea}\x05\x24\x13\x02\u{dc}\u{ea}\
	\x05\x26\x14\x02\u{dd}\u{ea}\x05\x28\x15\x02\u{de}\u{ea}\x05\x2a\x16\x02\
	\u{df}\u{ea}\x05\x2c\x17\x02\u{e0}\u{ea}\x05\x2e\x18\x02\u{e1}\u{ea}\x05\
	\x30\x19\x02\u{e2}\u{ea}\x05\x32\x1a\x02\u{e3}\u{ea}\x05\x34\x1b\x02\u{e4}\
